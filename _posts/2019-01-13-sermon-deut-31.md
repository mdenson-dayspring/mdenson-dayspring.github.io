...
<audio controls>
  <source src="https://docs.google.com/uc?export=download&id=1nJwBboK6ZC5ck64TWSiAxl2uMn_XTOJg" type="audio/mpeg">
  <!-- fallback for non supporting browsers goes here -->
  <p>Your browser does not support HTML5 audio, but you can still 
     <a href="https://drive.google.com/uc?authuser=0&id=1nJwBboK6ZC5ck64TWSiAxl2uMn_XTOJg&export=download">download the recording</a>.</p>
</audio>
