---
layout: post
title: Sermon, "It is all about the fruit"
...
<audio controls>
  <source src="http://docs.google.com/uc?export=open&id=1OUpJiRbtuSjQCeYeOJc3P1BWKhg_vG_r" type="audio/mpeg">
  <!-- fallback for non supporting browsers goes here -->
  <p>Your browser does not support HTML5 audio, but you can still 
     <a href="https://drive.google.com/uc?authuser=0&id=1OUpJiRbtuSjQCeYeOJc3P1BWKhg_vG_r&export=download">download the recording</a>.</p>
</audio>
